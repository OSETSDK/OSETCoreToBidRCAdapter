Pod::Spec.new do |s|
  s.name         = "OSETCoreToBidRCAdapter"
  s.version      = "6.6.4.9"
  s.summary      = "AdSet广告对接Tobid适配器"
  s.description  = <<-DESC
                    OSETSDK 是一个专业的广告聚合SDK，提供高效的广告展示和收益优化功能。
                    DESC
  s.homepage     = "https://github.com/OSETSDK/OSETCoreToBidRCAdapter"
  ...
  # 源文件配置
  s.source       = {
    :git => 'https://github.com/OSETSDK/OSETCoreToBidRCAdapter.git',
    :tag => s.version.to_s
  }
  # 主框架文件
  # 检查 OSETToBidAdapter.podspec 关键字段
  s.source_files = 'OSETCoreToBidRCAdapter/**/*.{h,m}'
  # 系统框架依赖
  ...
  s.dependency 'OSETCoreSDK','>=6.6.4.9'
